...
import com.savecash.safekash.models.NotificationLists;
...
public class Notification extends AppCompatActivity {
    ...
    private class  CustomAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            user_image.setImageResource(notifiction.getID());
            name.setText(notifiction.getName());
            balances.setText(notifiction.getAmount());
            date.setText(notifiction.getDate());
            action.setText(notifiction.getAction());
            phhone_num.setText(notifiction.getPhoneNum());
